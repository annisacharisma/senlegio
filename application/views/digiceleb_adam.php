...
foreach ($digiceleb as $u){
  ?>
<section data-bs-version="5.1" class="info1 cid-ui5JPqBsqg" id="info1-1t" style="background-image: url('<?php echo base_url('assets/'.$u->bg_dc); ?>');">
        ...
        <div class="row justify-items-center">
            <div class="col-12 col-lg-5" style="padding-top: 2rem; padding-left: 5rem">
                <div class="image-wrapper">
                    <img src="<?php echo base_url('assets/'.$u->image_dc1); ?>" style="height: 38rem; width: 27rem; object-fit: cover;">
                </div>
            </div>
            <div class="col-12 col-lg-7">
                <div class="text-wrapper">
                    ...
                    <img src='<?php echo base_url('assets/'.$u->image_dc2); ?>' style="height: 17rem; width: 37rem; object-fit: cover;">
